...
//
//     final getCompletedProjectModel = getCompletedProjectModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

GetCompletedProjectModel getCompletedProjectModelFromJson(String? str) =>
    GetCompletedProjectModel.fromJson(json.decode(str!));

String? getCompletedProjectModelToJson(GetCompletedProjectModel data) =>
    json.encode(data.toJson());

class GetCompletedProjectModel {
  ...
  final int? code;
  final String? status;
  final List<GetCompletedData>? data;

  factory GetCompletedProjectModel.fromJson(Map<String, dynamic> json) =>
      GetCompletedProjectModel(
        code: json["code"],
        status: json["status"],
        data: json["data"] == null
            ? null
            : List<GetCompletedData>.from(
                json["data"].map((x) => GetCompletedData.fromJson(x))),
      );
...
class GetCompletedData {
  ...
  factory GetCompletedData.fromJson(Map<String, dynamic> json) =>
      GetCompletedData(
